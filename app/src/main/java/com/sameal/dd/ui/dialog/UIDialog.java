...
public final class UIDialog {
    ...
    public static class Builder<B extends UIDialog.Builder>
        ...
        public B setConfirmColor(int color) {
            mConfirmView.setTextColor(color);
            return (B) this;
        }

        public B setConfirmVisiable(int visiable) {
            mConfirmView.setVisibility(visiable);
            return (B) this;
        }

        public B setConfirmBackground(int color) {
            mConfirmView.setBackgroundResource(color);
            return (B) this;
        }

        public String getConfirm() {
            return mConfirmView.getText().toString();
        }
