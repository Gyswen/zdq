 ...
 * desc 社区(审核)
 */
public class ReviewCommunityFragment extends MyFragment {
    public static ReviewCommunityFragment newInstance() {
        return new ReviewCommunityFragment();
    }
    ...
    protected int getLayoutId() {
        return R.layout.review_fragment_community;
    }
        ...
        EasyHttp.get(this)
                ...
                .request(new HttpCallback<HttpData<List<ForumCaseBean>>>(this) {
                    ...
                    public void onSucceed(HttpData<List<ForumCaseBean>> result) {
                        ...
                        if (result.getCode() == 1) {
                            mPagerAdapter.addFragment(ReviewRecommendFragment.newInstance(), getString(R.string.tj));
