...
public interface StatusAction {
    ...
    default void showEmpty() {
        showLayout(R.mipmap.icon_logo, R.string.hint_layout_no_data, null);
    }
    ...
    default void showError(View.OnClickListener listener) {
        ...
        if (manager != null) {
            ...
            if (info == null || !info.isConnected()) {
                showLayout(R.mipmap.icon_logo, R.string.hint_layout_error_network, listener);
                return;
            }
        }
